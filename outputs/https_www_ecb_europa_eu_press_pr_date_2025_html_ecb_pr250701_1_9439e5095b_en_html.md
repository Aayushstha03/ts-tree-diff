...
[Inflation results](/stats/ecb_surveys/consumer_exp_survey/results/html/inflation_results.en.html)
...
[Income and consumption results](/stats/ecb_surveys/consumer_exp_survey/results/html/income_and_consumption_results.en.html)
...
[Economic growth and labour market results](/stats/ecb_surveys/consumer_exp_survey/results/html/labour_market_and_growth_results.en.html)
...
[Housing and credit access results](/stats/ecb_surveys/consumer_exp_survey/results/html/housing_and_credit_access_results.en.html)

The release of the Consumer Expectations Survey (CES) results for June is scheduled for 29 July 2025.

**For media queries, please contact:** [Benoit Deeg](mailto:benoit.deeg@ecb.europa.eu)**, tel.: +49 172 1683704.**

#### Notes

*   Unless otherwise indicated, the statistics presented in this press release refer to the 2% winsorised mean. For further details, see [ECB Consumer Expectations Survey – Guide to the computation of aggregate statistics](/stats/ecb_surveys/consumer_exp_survey/shared/pdf/CES_aggregate_statistics_guide.en.pdf).
