...
1.1. This Statement of Policy (SoP) sets out the Bank of England’s (‘the Bank’) approach to giving a regulatory permission to recognised non-UK central counterparties (CCPs) on the basis of comparable compliance (a ‘comparable compliance permission’). This is set out in the [Bank of England FMI Rulebook: Overseas Central Counterparties Instrument](https://www.bankofengland.co.uk/-/media/boe/files/paper/2025/boe-fmi-rulebook-overseas-ccps-instrument-2025.pdf "Opens in new window") (hereon Overseas CCPs Part of the CCP rules). Where relevant, this SoP also sets out the Bank’s approach to variations to that permission, and the circumstances under which the Bank may take the decision to revoke that permission. When giving, varying or revoking a comparable compliance permission, the Bank would exercise its powers under section 138BA (s138BA) of the Financial Services and Markets Act 2000 (FSMA).[footnote \[1\]](#footnote-1)

1.2. Under \[s300ED(4) and s300EF(1)\] of FSMA, the Bank is required to consider whether to determine that a non-UK CCP applying for UK recognition is systemically important, or likely to become systemically important, to UK financial stability. Where the Bank makes such a determination, it will designate that CCP as ‘systemic’; where it considers that it will not do so, it will designate that CCP as ‘non-systemic’. This process is referred to as ‘tiering’ and the approach is set out in the Bank’s SoP – the Bank of England’s approach to tiering non-UK central counterparties (herein referred to as the Tiering SoP).[footnote \[2\]](#footnote-2) A non-UK CCP that is designated as systemic will, once it is recognised, be subject to direct UK supervision and regulation through the application of certain Bank rules to it (in accordance with rule 3.1 of the Overseas CCPs Part of the CCP rules). Where a non-UK CCP is designated as non-systemic, after the CCP is recognised the Bank will rely on the supervision and regulation of the home authority.[footnote \[3\]](#footnote-3)
...
2.22. This is without prejudice to the Bank’s statutory duties, including its supervisory responsibilities in relation to systemic overseas CCPs under \[s300EJ\] of FSMA and its powers to withdraw recognition subject to the conditions under \[s300EK\] of FSMA.[footnote \[4\]](#footnote-4)
...
2.25. The Bank expects the CCP and/or its home authority to notify the Bank of changes set out in paragraph 2.24 in a timely manner.[footnote \[5\]](#footnote-5) The Bank may request updated information from the CCP and/or its home authority to help assess whether there have been, or are likely to be, changes set out in paragraph 2.24.
...
1.  s138BA of FSMA is applied in relation to rules made by the Bank in respect of CCPs under paragraph 10 of Schedule 17A to FSMA.
    
2.  [Statement of Policy: The Bank of England’s Approach to tiering non-UK CCPs](https://www.bankofengland.co.uk/paper/2025/sop/the-bank-of-englands-approach-to-tiering-non-uk-ccps)
    
3.  Non-systemic CCPs are subject to ongoing notification requirements following recognition, as set out under rules 2.2 and 2.3 of the Overseas Part of the CCP rules.
    
4.  Under \[s300EJ\] of FSMA, the Bank must require systemic overseas CCPs to provide confirmation on at least an annual basis that certain recognition conditions continue to be met. Conditions include ensuring effective compliance with rules made by the Bank that apply to systemic overseas CCPs (as set out in the Overseas CCPs Part of the CCP rules).
    
5.  Rule 4.1 of the Overseas CCPs Part requires systemic overseas CCPs to notify the Bank of any material changes relevant to whether they meet the conditions for recognition. The Bank’s cooperation and information sharing arrangements with the home authority may also include provision in relation to notification of the events set out in paragraph 2.24.